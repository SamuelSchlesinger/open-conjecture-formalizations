...
- **1/3–2/3 conjecture** — Kislitsyn, S. S. "Finite partially ordered sets and their associated sets of permutations." *Matematicheskie Zametki* 4 (1968), 511–518. [In-repo project](order-theory/one-third-two-thirds/)
...
- **Hadamard conjecture** — Hadamard, J. "Résolution d'une question relative aux déterminants." *Bull. Sci. Math.* 17 (1893), 240–246. [Submodule](combinatorics/hadamard-conjecture/)
  - Paley, R. E. A. C. "On orthogonal matrices." *J. Math. Phys.* 12 (1933), 311–320. (Constructions I/II from quadratic characters — see `Hadamard.Paley` for the formalized construction I.)
  - Ireland, K.; Rosen, M. *A Classical Introduction to Modern Number Theory.* 2nd ed., Springer GTM 84, 1990, Chapter 8. (Jacobi-sum evaluation behind the Jacobsthal character-sum lemma in `Hadamard.Jacobsthal`.)
  - Kharaghani, H.; Tayfeh-Rezaie, B. "A Hadamard matrix of order 428." *J. Combin. Des.* 13 (2005), 435–440. (Smallest currently unknown order is 668.)
